...
#PJM -L  "elapse=10:00:00"                 # Elapsed time
...
output_dir=/data/ra000012/spring8_image_recon_output/GC_24576_v3_${output_slice_size}_output_${sample_size}_${R_size}_${XYZ_size}/

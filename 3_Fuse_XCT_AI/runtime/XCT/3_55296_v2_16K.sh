...
output_dir=/data/ra000012/spring8_image_recon_output/GC_55296_v2_${output_slice_size}_output_${sample_size}_${R_size}_${XYZ_size}/
...
EXEFILE=${PROJECT_ROOT}/build/v2_MPI_FBP_main

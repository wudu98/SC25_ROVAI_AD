...
output_dir=/data/ra000012/spring8_image_recon_output/GC_6144_v3_weak_${output_slice_size}_output_${sample_size}_${R_size}_${XYZ_size}/
...
while read -r line; do
    ...
    for ((i=0; i<$scan_count; i++)); do
        ...
        if [[ $(($weak_scale_rank % 24)) -ne 0 ]]; then
            continue
        fi
